...
├── WingAirdropController            翅膀高空石块投放、命中与表现
...
- `tests/consumable_effects_smoke.gd` 覆盖 3×3 Glue、分级 AI 认知、全图雷管、Wing 高空免疫/石块空投、足球鞋踢弹、9×9 油火连锁/持续伤害、9×9 Prison 群控、可见动画节点和决斗进攻系数。
